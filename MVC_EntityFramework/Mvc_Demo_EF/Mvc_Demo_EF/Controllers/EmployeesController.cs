...
namespace Mvc_Demo_EF.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Gender,DepartmentId")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Gender,DepartmentId")] Employee employee)
        {
            if (ModelState.IsValid)
            {
